...
export default function() {
    ...
    cityDomainList.forEach((l) => noFedMap.set(l, l));
    stateDomainList.forEach((l) => noFedMap.set(l, l));
    countyDomainList.forEach((l) => noFedMap.set(l, l));
    eduDomainList.forEach((l) => noFedMap.set(l, l));
